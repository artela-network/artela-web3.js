...
import { ValidatorAttestationsHeaderBox } from './views/validator/validatorAttestationsHeaderBox'
import { ValidatorAttestationsTable } from './views/validator/validatorAttestationsTable'
